...
<nav class="navbar navbar-expand navbar-light topbar static-top mb-4 bg-white shadow">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <!-- Nav Item - Messages -->
        <li class="nav-item dropdown no-arrow mx-1">
            <a class="nav-link dropdown-toggle" id="messagesDropdown" data-toggle="dropdown" href="#"
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="dropdown-list-image mr-3">
                        <img class="rounded-circle" src="{{ asset('/dashboard/img/undraw_profile_1.svg') }}"
                            alt="{{ asset('/dashboard/img/undraw_profile_1.svg') }}">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="dropdown-list-image mr-3">
                        <img class="rounded-circle" src="{{ asset('/dashboard/img/undraw_profile_2.svg') }}"
                            alt="{{ asset('/dashboard/img/undraw_profile_2.svg') }}">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="dropdown-list-image mr-3">
                        <img class="rounded-circle" src="{{ asset('/dashboard/img/undraw_profile_3.svg') }}"
                            alt="{{ asset('/dashboard/img/undraw_profile_3.svg') }}">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="dropdown-list-image mr-3">
                        <img class="rounded-circle" src="https://source.unsplash.com/Mv9hjnEUHR4/60x60"
                            alt="https://source.unsplash.com/Mv9hjnEUHR4/60x60">
                        <div class="status-indicator bg-success"></div>
                    </div>
                    <div>
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" id="userDropdown" data-toggle="dropdown" href="#"
                ...
                <img class="img-profile rounded-circle" src="{{ asset('/dashboard/img/undraw_profile.svg') }}"
                    alt="{{ asset('/dashboard/img/undraw_profile.svg') }}">
            </a>
